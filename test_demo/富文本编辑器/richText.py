...
from PySide6.QtCore import Signal, Qt, QSize, QMargins
from PySide6.QtGui import QFont, QBrush, QColor, QIcon, QPixmap, QPalette, QTextCharFormat, QTextCursor
...
class RichTextWindow(QMainWindow):
    ...
    def update_recently_colors(self, color_type):
        ...
        for color_item in colors:
            pix = QPixmap('media/rich_text/3.ico')
