...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_img = QAction(MainWindow)
        self.action_img.setObjectName(u"action_img")
        icon4 = QIcon()
        icon4.addFile(u":/icons/img/tp.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_img.setIcon(icon4)
...
"selection-background-color:DeepSkyBlue")
        ...
        self.menu_edit.addSeparator()
        self.menu_edit.addAction(self.action_img)
        ...
        self.toolBar_quick.addAction(self.action_img)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_img.setText(QCoreApplication.translate("MainWindow", u"\u63d2\u5165\u56fe\u7247", None))
